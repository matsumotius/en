$(function(){
    ...
    var En = function(_target, _options){
        ...
        this.is_smartphone = navigator.userAgent.match(/iPhone/) || 
    ...
    EnManager.prototype.apply_events = function(target){
        ...
        var events = this.is_smartphone ? EN_SMARTPHONE_EVENTS : EN_PC_EVENTS;
        var this_is_smartphone = this.is_smartphone;
        $.each(events, function(index, en_event){
            $(target).bind(en_event, function(e){
                ...
                var event_obj = this_is_smartphone ? { pageX : pageX, pageY : pageY } : e;
